...
@Component
public class TestDataStoreFile implements TesterDataStore
{
   private static final Logger logger = LoggerFactory.getLogger(TestDataStoreFile.class);
   private static final String BUGS_FILE = "data/bugs.csv";
   private static final String DEVICES_FILE = "data/devices.csv";
   private static final String TESTERS_FILE = "data/testers.csv";
   private static final String TESTER_2_DEVICE_FILE = "data/tester_device.csv";
